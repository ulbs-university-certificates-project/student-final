...
public static class Constants
{
    ...
    public const string CERTIFICATE_DOCUMENT_CREATED = "Certificate successfully created.";
    public const string CERTIFICATE_DOCUMENT_DELETED = "Certificate successfully deleted.";
    ...
    // PATHS
    public const string BASE_PATH = @"C:\university-certs\student-final\student-final\";
